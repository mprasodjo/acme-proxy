...
func New(cfg *config.Config, opts ...Option) (*CA, error) {
	// Optionally disable outbound ACME challenge validation (proxy
	// deployments where domain control is proven toward the upstream CA).
	acme.SkipChallengeValidation = cfg.DisableChallengeValidation
